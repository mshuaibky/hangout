  ...
  return (
    <div >
      <nav className="relative px-8 py-4 flex justify-between items-center border-y border-gray-400 dark:border-gray-700">
       ...
       <Link to='/owner-home'>Hangout</Link>
          </span>
        </a>
        ...
        <li>
            ...
            <Link className="text-sm text-gray-600 font-bold" >Dashboard</Link>
          </li>
        
          <li>
          <Link className="text-sm text-gray-600 font-bold" >Users</Link>

          </li>
          <li>
          <Link className="text-sm text-gray-600 font-bold" to='/owner-home'>Restaurants</Link>

          </li>
         
          <li>
          <Link className="text-sm text-gray-600 font-bold" to='/owner-login'>Orders</Link>

          </li>
          <li>
          <Link className="text-sm text-gray-600 font-bold" to='/owner/view-dish'>Dishes</Link>

          </li>
          <li>
          <Link className="text-sm text-gray-600 font-bold" to='/owner-login'>Tables</Link>
